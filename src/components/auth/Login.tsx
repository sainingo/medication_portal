      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        {/* <div className="flex justify-center">
          <img 
            ...
            src={pharmacyLogo} 
            alt="Pharmacy Distribution System" 
          />
        </div> */}
        ...
        <p className="mt-2 text-center text-sm text-gray-600 max-w">
          Connecting to AMRS for seamless medication distribution
        </p>
      </div>
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 pr-10 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 sm:text-sm"
                  placeholder="••••••••"
                />
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">
                  Pharmacy Distribution System v1.0
                </span>
              </div>
            </div>
          </div>
